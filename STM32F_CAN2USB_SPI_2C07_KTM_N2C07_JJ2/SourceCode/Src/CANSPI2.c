...
/* CAN Send message */
uint8_t CANSPI2_Transmit(uCAN2_MSG *tempCanMsg) 
{
...
/* CAN Receive message */
uint8_t CANSPI2_Receive(uCAN2_MSG *tempCanMsg) 
{
  uint8_t returnValue = 0;
  rx_reg_t rxReg;
...
uint8_t CANSPI2_messagesInBuffer(void)
{
...
uint8_t CANSPI2_isBussOff(void)
{
  uint8_t returnValue = 0;
...
uint8_t CANSPI2_isRxErrorPassive(void)
{
  uint8_t returnValue = 0;
...
uint8_t CANSPI2_isTxErrorPassive(void)
{
  uint8_t returnValue = 0;
